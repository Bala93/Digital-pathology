...
if __name__ == "__main__":
    ...
    val_img_path    = '/media/htic/NewVolume1/murali/mitosis/mitotic_count/test_images_normalization_Macenko_test/*.bmp'
    ...
    with detection_graph.as_default():
        with tf.Session() as sess:
            ...
            stride =  393 #265 #457  # check for maximum mitotic cell.
            ...
            for in_img_path in tqdm(img_paths):
                ...
                for each_trans in tqdm(eval_transform_list):
                    ...
                    for row in tqdm(range(no_of_rows)):
                        for col in tqdm(range(no_of_cols)):
                            ...
                            # Only for 1024 patch size
                            #image_np = transform.rescale(image_np,2,order=3)
                            ############
                ...
                if(len(boxes)>0):   
                    ...
                    [cv2.rectangle(gt_box_img,(xmin,ymin),(xmax,ymax),(255,0,0),5)for xmin,ymin,xmax,ymax in boxes]
