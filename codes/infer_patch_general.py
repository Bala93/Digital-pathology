...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required = True,
        type = str,
        help = 'path containing validation images'
    )
    ...
    parser.add_argument(
        ...
        required = True,
        type = str,
        help = 'path containing gt images'
    )
    ...
    val_img_ext = opt.val_img_ext
    img_gt_path = opt.img_gt_path
    label_path = '/media/htic/NewVolume1/murali/Object_detection/models/research/data/mitosis_label_map.pbtxt'
    predicted_json_path = os.path.join(result_path,'predicted_out.json')
    val_img_path = os.path.join(val_img_path,val_img_ext)
    ...
    with detection_graph.as_default():
        with tf.Session() as sess:
            ...
            for in_img_path in tqdm(img_paths):
                ...
                gt_box_img_path = os.path.join(img_gt_path,file_name.replace('.bmp','.jpg'))
