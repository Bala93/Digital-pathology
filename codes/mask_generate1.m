function mask_generate1(mask_whole_path,mask_sample_path,img_sample_path)
...
for whole_mask_count = 1: mask_whole_files_total
   ...
   for each_sample_mask = 1:no_mask_sample_files
       ...
       if mask_img_sum>0
           [sample_mask_area,sample_mask_bw,mask_img]=getArea1(mask_path);
           flag=removebrokencell1(sample_mask_bw,whole_mask_area,sample_mask_area);
           if flag==2   
            ...
            copyfile(src_mask_path,dest_mask_path);
           end
