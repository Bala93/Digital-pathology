...
if __name__ == "__main__":
    ...
    python augment_mitosis.py --inp_img_path=/media/htic/Balamurali/out-AB/A/train/ --inp_mask_path=/media/htic/Balamurali/out-AB/B/train/ --out_img_path=/media/htic/Balamurali/out-AB/A/train/ --out_mask_path=/media/htic/Balamurali/out-AB/B/train/ --no_samples=500
